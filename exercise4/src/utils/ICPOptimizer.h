...
public:
	...
	bool operator()(const T* const pose, T* residuals) const {
        ...
        T transformed_point[3], source_point[3];
        source_point[0] = T(m_sourcePoint.x());
        source_point[1] = T(m_sourcePoint.y());
        source_point[2] = T(m_sourcePoint.z());

        PoseIncrement<T> pose_increment(pose_array);
        pose_increment.apply(source_point,transformed_point);

		residuals[0] = T(m_weight)*(transformed_point[0]-T(m_targetPoint(0)));
		residuals[1] = T(m_weight)*(transformed_point[1]-T(m_targetPoint(1)));
		residuals[2] = T(m_weight)*(transformed_point[2]-T(m_targetPoint(2)));
...
public:
	...
	bool operator()(const T* const pose, T* residuals) const {
        ...
        T res[3];
        res[0] = transformed_point[0]-T(m_targetPoint(0));
        res[1] = transformed_point[1]-T(m_targetPoint(1));
        res[2] = transformed_point[2]-T(m_targetPoint(2));

        res[0] = res[0] * T(m_targetNormal[0]);
        res[1] = res[1] * T(m_targetNormal[1]);
        res[2] = res[2] * T(m_targetNormal[2]);

        residuals[0] = res[0] + res[1] + res[2];
        residuals[0] = T(m_weight) * residuals[0];
